...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'frontend/build'),  # React build first
            os.path.join(BASE_DIR, 'frontend/static'),  # Static HTML templates second
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend/build/static'),  # React build static files first
    os.path.join(BASE_DIR, 'frontend/static'),  # Your static files second
